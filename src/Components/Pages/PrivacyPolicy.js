...
const PrivacyPolicy = () => {
  return (
    <div className="legal-container">
      ...
      <h3 className="section-title fw-bold">Interpretation and Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Happy Co., Surabaya,
            Indonesia.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Polarogram, accessible from{' '}
            <a
              href="https://www.polarogram.com"
              rel="external nofollow noopener noreferrer"
              target="_blank"
              className="link">
              https://www.polarogram.com
            </a>
          </p>
        </li>
        <li>
      ...
      <h3 className="section-title fw-bold">Collecting and Using Your Personal Data</h3>
      <h4 className="subtitle">Types of Data Collected</h4>
      <h5>Personal Data</h5>
      <p>
      ...
      <h3 className="section-title fw-bold">Use of Your Personal Data</h3>
      ...
      <h3 className="section-title fw-bold">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="section-title fw-bold">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="section-title fw-bold">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="section-title fw-bold">Security of Your Personal Data</h3>
      <p>
      ...
      <h3 className="section-title fw-bold">Children's Privacy</h3>
      <p>
      ...
      <h3 className="section-title fw-bold">Links to Other Websites</h3>
      <p>
      ...
      <h3 className="section-title fw-bold">Changes to this Privacy Policy</h3>
      <p>
      ...
      <h3 className="section-title fw-bold">Contact Us</h3>
      <p>If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul>
        <li>By email: customersupport@polarogram.com</li>
      </ul>
      <p className="text-muted small text-center legal-copyright">
