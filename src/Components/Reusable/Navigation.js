          ...
          <ul className="navigation-links">
            <li className={`navigation-link`} id="home">
              <NavLink
                ...
                <svg
                  className="navigation-icon filled"
                  viewBox="0 0 97 97"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            {notifications === 0 && (
              <li
                ...
                <svg
                  className="notification-icon navigation-icon"
                  viewBox="0 0 51 51"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
                ...
                <svg
                  className="notification-icon filled navigation-icon"
                  width="51"
                  height="51"
                  viewBox="0 0 51 51"
                  fill="none"
            ...
            {notifications > 0 && (
              <li
                ...
                id="notification">
                <svg
                  className="notification-icon badged navigation-icon"
                  viewBox="0 0 51 51"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
                ...
                <svg
                  className="notification-icon filled badged navigation-icon"
                  viewBox="0 0 51 51"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
